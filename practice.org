...
To sum up, buildings are supposed to serve their functions and should be made more useful. However, the visually pleasing outlook of a building also plays a crutial role because it not only harness the satisfaction of the residents, but will significantly influence the living quality of the local district as well.
(2:
